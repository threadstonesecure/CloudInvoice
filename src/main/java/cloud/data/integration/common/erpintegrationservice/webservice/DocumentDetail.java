...
@XmlType(name = "DocumentDetail", namespace = "http://xmlns.oracle.com/apps/financials/commonModules/shared/model/erpIntegrationService/", propOrder = {
    "content",
    "fileName",
    "contentType",
    "documentTitle",
...
public class DocumentDetail {
    ...
    @XmlElementRef(name = "FileName", namespace = "http://xmlns.oracle.com/apps/financials/commonModules/shared/model/erpIntegrationService/", type = JAXBElement.class, required = false)
